        ...
        <div class="row">
          <div class="col-12">
           <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="feestypetable" class="table table-bordered table-striped">
...
<script type="text/javascript">
     ...
     activeProjectDatatable = $('#feestypetable').DataTable({
        "language": {
            "processing": ''
        },
