        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Cources List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
           ...
           <div class="card">
              ...
              <div>
                <button class="btn btn-primary btn-sm float-sm-right" style="background:white; border-radius:22px;">
                  <a href=" {{ url('admin/cource')}} ">
                   <i class="fas fa-plus"></i> Add Cources
                  </a>
                </button>
                 </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="courcetable" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                     <th>Id</th>
                    <th>Name</th>
...
<script type="text/javascript">
     ...
     activeProjectDatatable = $('#courcetable').DataTable({
        "language": {
            "processing": ''
        },
        ...
        "columns": [null, null,null,null, null, {className: "td-actions"}, null, null, null],        
    });
